...
class BackEnd:
    ...
    def __init__(self):
        ...
        self.table_columns = ["REG","FNAME","LNAME","AGE","EMAIL","COURSE","USERNAME"]
    ...
    def add(self, reg, fn, ln, age, email, course, user):
        ...
        elif (not (isinstance(email, str))):  # not (or re.search(email_regex,email))):
            print("Invalid EMAIL")
            print("*** Adding Record Failed ***")
        ...
        if reg and reg.strip():
            ...
            if check.fetchone()[0] == 0:
                ...
                if (targetAttribute == "FNAME"):
                    ...
                    print("Columnn Selected does not exist. \tAvailable columns: " + str(self.table_columns))
                    print("*** Update Record Failed ***")
